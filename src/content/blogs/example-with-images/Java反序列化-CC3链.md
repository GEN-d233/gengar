...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=N2Q3ODk2ZGU4YmM0Y2I2ZWIwYTc1ZThmYTU2NjY3YWNfWDhIUklybHFDNzZoc0U1aVVaWXF6dDR5amx4dllTb0NfVG9rZW46RXVWWGJDSkxhb1ZlNzR4MWRuMmNHdVlWbmtWXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=MmYyYjNhNjRhMGYxZDE3NTJlMGYzOWRhNmVkNGM1MmJfMnZBbHRlT3d2QXN1Q2FSTUk0OUszU1lyR3pLV2tqU0lfVG9rZW46SzZ5QmJxQ2FTb2FsT3p4TmYzSmNOWGlRblpiXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=NjE1N2ViMDFmYjkxYTEwY2MzNWQyMzM0NGZlM2NkNGFfaVVETTVvdE1hRGFWcEVsc1pxdHl0em1FQlBKcGRzbzZfVG9rZW46RFVjRWJMUEtKbzlkN0p4Rm9tNGNDc0ltbmFiXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=NDExZjQ1Nzg4MjYzOWFlOTBlNmQzMzJiZTRlMjU5NmVfOWlTTVV4ckJsUmZabUZBaXI0VWdIcm5IaUxKZDZFRzRfVG9rZW46TDVCR2JrdlQyb2JNbUt4WjlwTGMxN3RlbkNoXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=ZGUyYjgzYTQ2ZWZjMDhkM2NkZTQ5NzQzZDExNjNhNjNfelVWR0N4NXVDd2ZjaTM0QmxOZmkzRGg3YkpKajg1NmVfVG9rZW46RkNWTmJscFhGb05vQ1F4R0cxZWNDeXFObnZmXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=MmNlN2QwZmU4NTNmMDcyOTUzMTNhNTgwNzE4MDM3ZTBfb3o1eWp0TWE1WGpVUVlJY3JscWpnOXNlcXluQVBhSWlfVG9rZW46SVY3aGIxVzZ2bzVMUnZ4a2d0U2NoYUlYbnZtXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=OGNlMmJjZGVhYmY1MWIyYjU5ZGQ4YmEyZmRhYjc5MDJfaWZEdEtCb0lOQ3g2R3NDUkF0aE9UYmVOYksxcGlXM1pfVG9rZW46WWZSTmJ2OVhybzZkNzB4TEV5b2NWbGVNbkFmXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)

报错提示出现在`TemplatesImpl`的422行，我们在上面打上断点调试看看问题

首先_class[i]，成功获取_bytecodes[i]字节码，superClass获取其父类

![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=NzVjZmNjZTAwNTk1YjRiM2Q2OWIxOGVmNzAyOTQwMjFfekNxZFhtQ2V5Zlg1MldYaDZIWWhNTlFsa24xYk5ZNzhfVG9rZW46Q0tORWJ5VXFibzJVbFN4Z3lRUGNoTU9LblZnXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)

判断父类名是否为`ABSTRACT_TRANSLET`，因为我们没有继承`ABSTRACT_TRANSLET`因此进入到else代码块

可以看到`_auxClasses`旁有了报错`NullPointException`

![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=ODhhM2Y5NDJhNjRmOTVmNzk0M2U3ZjQwOTk1YWYzNGVfRVBYSzV1OVZKb3dRa0l3TUJGbEhWankwRUxaaGd5QkFfVG9rZW46WllnVWJuY3hub1Vpdlp4ZmZLMmNuNjRIbmpiXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=NTM4M2ZjNDU5ZDExZGFiZGI1Yjk3ODRjZDQ3ZmUzYWJfMGZOZXlENnBGQnU2SW14QjdNUjBWUUY4c3BZQXhGVmpfVG9rZW46U1hRQ2JRYzh3b1k2bG94R0lucWN0Z096bm5oXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)

## 0x05 CC1链的TemplatesImpl实现

前面的链子不变，只改变最后的命令执行方式，通过动态加载类实现

![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=ZGQ2ZTI5M2MzMTNiMzI1YjUwM2U4YzY2ZWUzMTI4ODVfOFMwMGRkNjdXRE9pdDFodTV4enA2eG5uOVZIaFY1UEpfVG9rZW46TlJ0NGJBelNGb3I3aUJ4ZU83VWNRemJwbkhmXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=ZDMwM2Y1MDNkOGRjZGEzZjE0ZjQ0NGY1MWRkM2QwM2NfNnFZZmdxMU5BelczZFowZG1pbk9NSlVOdVEzbW91UUFfVG9rZW46VjhjUGJNbGgyb29QcU54Sk1ONWNQbjVFbkplXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)

进入`TrAXFilter`类，虽然没有继承`Serializable`接口，但是在它的构造方法中实现`newTransformer()`，构造函数的参数也方便控制，所以我们只要执行这个类的构造函数即可命令执行

![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=Y2Y1YTExZTdlNDg5NTE2ZDUwMjc3YTM0Y2VkYWE1MTZfOEtJVUdkTzFXbUYxUEhWNUtPZ3RveGNMM2VEa0JJSWpfVG9rZW46Tml0cWJqdzR1b2V2TUl4ZnBtMmNLcGJ4bnVlXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
...
![img](https://my.feishu.cn/space/api/box/stream/download/asynccode/?code=YTlkYTJlNzQxOTI0OGQxOGZiOTQzNDUzM2M3NDg2ZGVfYmV2UWw1eFJsbzRCNURGZWIydllsdk16VzVLRXJqSFdfVG9rZW46SWkyTmJxZTNQb3JTaG54QlBPc2NEZG9DbllkXzE3NzM4MzM3MDA6MTc3MzgzNzMwMF9WNA)
