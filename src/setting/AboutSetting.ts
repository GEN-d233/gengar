...
//个人信息部分配置
const AVATAR_FILENAME = "Screenshot_2026_0322_011305.png"; //头像配置，头像需要放进public文件夹内，这里只写文件名和后缀
//处理头像路径的函数(无需修改)
...
//关于我页面一二三段
export const aboutMeP1 = "天津理工大学信息安全专业大一小登，废物web手 ";
...
export const mail = "mailto:taoshan67523@163.com"; //邮箱配置
export const github = "https://github.com/GEN-d233"; //github网站配置
